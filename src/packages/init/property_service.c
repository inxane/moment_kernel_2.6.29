...
struct {
    ...
    { "net.pdp0.local-ip",	AID_RADIO },
    { "net.pdp0.dns1",		AID_RADIO },
    { "net.pdp0.dns2",		AID_RADIO },
    { "net.",           AID_SYSTEM },
    { "dev.",           AID_SYSTEM },
    { "runtime.",       AID_SYSTEM },
    { "hw.",            AID_SYSTEM },
...
//#ifdef CONFIG_MACH_INSTINCTQ
    ...
    { "net.ppp0.",        AID_RADIO },
#endif
// Change the btld(broadcom bluetooth stack) permission (root -> bluetooth)
    { "service.brcm.bt.", AID_BLUETOOTH,0 },
    { "persist.service.brcm.bt.mac", AID_BLUETOOTH,0 },
//End - btld permission
    { "audioflinger.", AID_MEDIA,   0 },
    { NULL, 0 }
};
...
void property_init(int bootmode)
#else
...
#if defined(CONFIG_MACH_SATURN)
    if(bootmode == 2) {
        load_properties_from_file("/default.prop.eng");
    } else {
