...
#if 0	/* To Use Eclair Header */ 
#include <private/android_filesystem_config.h>
#else
#include "../../open_src/system/core/include/private/android_filesystem_config.h"
#endif
#include <sys/time.h>
#include <asm/page.h>
...
static struct perms_ devperms[] = {
    ...
    { "/dev/bma150",		0777,	AID_SYSTEM,		AID_SYSTEM,		0 },
...
//#ifdef CONFIG_MACH_INSTINCTQ
#if defined(CONFIG_MACH_INSTINCTQ) || defined (CONFIG_MACH_CYGNUS)
    { "/dev/ttyCDMA0", 	    0664,   AID_RADIO,	    AID_RADIO,      0 },
    { "/dev/ppp",		    0666,   AID_RADIO,      AID_RADIO,      0 },
	{ "/dev/proximity",		0777,	AID_SYSTEM,		AID_SYSTEM,		0 },
    { "/dev/ttyCIQ0",       0664,   AID_SYSTEM,     AID_SYSTEM,     0 },
#endif
#if defined (CONFIG_MACH_SATURN) || defined (CONFIG_MACH_BONANZA)
    { "/dev/Si4709",        0777,   AID_SYSTEM,     AID_AUDIO,       0 },
#endif
    ...
    { "/dev/swmxctl",        0666,   AID_SYSTEM,     AID_SYSTEM,       0 },
    { "/dev/uwibro",        0666,   AID_SYSTEM,     AID_SYSTEM,       0 },
#endif
#if defined (CONFIG_MACH_SATURN)
    { "/dev/ams320fs01",        0777,   AID_SYSTEM,     AID_GRAPHICS,       0 },
#endif
    { NULL, 0, 0, 0, 0 },
};
...
int load_wimax_driver()
{
        ...
        ERROR(" Loading the wimax driver \n ");
        if (insmod("/lib/modules/cmc7xx_sdio.ko", "firmware_path=/tmp/cmc730_u200_rev1_LProject_20580_1055_CF01.bin") < 0) {
                ERROR("insmod() failed!!\n");
                return -1;
        }
        return 0;
